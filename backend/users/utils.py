      ...
      <table width="480" cellpadding="0" cellspacing="0"
        ...
        <tr>
          <td style="padding:36px 40px;">
            ...
            <p style="margin:0 0 28px;color:#94a3b8;font-size:15px;line-height:1.6;">
              Use the code below to verify your email address. It expires in <strong style="color:#e2e8f0;">10 minutes</strong>.
            </p>
        ...
        <tr>
          <td style="padding:20px 40px;border-top:1px solid #334155;text-align:center;">
            <p style="margin:0;color:#475569;font-size:12px;">© 2026 Finance Tracker</p>
          </td>
        </tr>
      </table>
    </td></tr>
