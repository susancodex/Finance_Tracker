  ...
  return (
    <div className="max-w-2xl mx-auto space-y-4 sm:space-y-6">
      ...
      <div className="animate-fade-in-up">
        <h1 className="font-display text-2xl sm:text-3xl font-bold text-slate-100">Profile</h1>
      ...
      <div className="card animate-fade-in-up-delay-1">
        ...
        {/* Avatar + name header */}
        <div className="flex items-center gap-4 mb-5 sm:mb-6 pb-5 sm:pb-6 border-b border-slate-800">
          ...
          <div className="relative flex-shrink-0 group">
            {avatarSrc ? (
              <img
                src={avatarSrc}
                alt="Profile"
                className="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl object-cover border-2 border-emerald-500/30"
              />
            ) : (
              <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl bg-gradient-to-br from-emerald-400 to-teal-500 flex items-center justify-center text-slate-950 font-bold text-xl sm:text-2xl">
                {initials}
              </div>
            )}
          ...
          <div className="flex-1 min-w-0">
            <p className="font-display text-lg sm:text-xl font-bold text-slate-100 truncate">{user?.username || 'User'}</p>
        ...
        {avatarFile && (
          <div className="mb-5 p-3 rounded-xl bg-slate-800/60 border border-slate-700 flex items-center gap-3">
            ...
            <button onClick={handleAvatarCancel} className="text-slate-500 hover:text-slate-300 transition-colors px-2">✕</button>
            <button
              onClick={handleAvatarUpload}
              disabled={uploadingAvatar}
              className="btn-primary text-sm px-3 sm:px-4 py-2 flex items-center gap-2 flex-shrink-0"
            >
      ...
      <div className="card animate-fade-in-up-delay-2">
        <h2 className="font-display text-base sm:text-lg font-bold text-slate-100 mb-5 sm:mb-6">Change Password</h2>
