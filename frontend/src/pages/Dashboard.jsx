    ...
    <div className="max-w-5xl mx-auto space-y-5 sm:space-y-8">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        ...
        <StatCard
          ...
          icon={
            <svg className="w-4 h-4 sm:w-5 sm:h-5 text-emerald-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        ...
        <StatCard
          ...
          accent="bg-red-500"
          icon={
            <svg className="w-4 h-4 sm:w-5 sm:h-5 text-red-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      <div className="card animate-fade-in-up-delay-3">
        <div className="flex items-center justify-between mb-4 sm:mb-6">
          <h2 className="font-display text-base sm:text-lg font-bold text-slate-100">Recent Transactions</h2>
        ...
        {recent.length === 0 ? (
          ...
          <div className="space-y-1.5 sm:space-y-2">
            {recent.map((tx) => {
              ...
              return (
                <div key={tx.id} className="flex items-center gap-3 p-2.5 sm:p-3 rounded-xl hover:bg-slate-800/50 transition-colors">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-slate-500 truncate">{getCategoryName(tx.category)} · {tx.date || tx.created_at?.slice(0, 10)}</p>
                  </div>
                  <span className={`text-sm font-mono font-medium flex-shrink-0 ${isIncome ? 'text-emerald-400' : 'text-red-400'}`}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
        {categorySpend.length > 0 && (
          <div className="card animate-fade-in-up-delay-4">
            <div className="flex items-center justify-between mb-4 sm:mb-6">
              <h2 className="font-display text-base sm:text-lg font-bold text-slate-100">Top Expenses</h2>
        ...
        <div className="card animate-fade-in-up-delay-4">
          <div className="flex items-center justify-between mb-4 sm:mb-6">
            <h2 className="font-display text-base sm:text-lg font-bold text-slate-100">This Month</h2>
          </div>
          {(() => {
            const now = new Date()
